"Try Logic", "Lógica Passo a Passo";
"English", "Português";
...
"Click here to execute this code", "Clique aqui para executar este código";
  ...
  "Move to step 1 of the current lesson", "Ir a 1º etapa da lição atual";
  "See available lessons", "Acessar lições disponíveis";
  "See available steps in the current lesson", "Acessar etapas disponíveis da lição atual";
  "Move to the next step", "Ir a próxima etapa";
  "Move to the previous step", "Voltar a etapa anterior";

  "You moved to lesson", "Você passou para a lição";
  "step", "etapa";
  "Congratulations", "Parabéns";
  "You moved to the next lesson", "Você passou para a lição seguinte";
  "You moved to the next step", "Você passou para a etapa seguinte";
  "All steps in lesson", "Todas as etapas da lição";
