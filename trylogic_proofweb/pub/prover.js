...
function undo_cb(z) {
  ...
  get_frame("frame_error").body.innerHTML = "<div align=\"center\"><pre> " + unicode(rest.substring(index + 7)) + "</pre><div>";
...
function query_cb(z) {
  ...
  var out = "<div align=\"center\"><pre>" + unicode(z.substring(0, index)) + unicode(rest.substring(index2 + 7)) + "</pre><div>";
