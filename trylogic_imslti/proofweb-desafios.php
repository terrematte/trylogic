...
if ( $context->valid ) {
	print "<form action=\"/logged.html\" method=\"post\" name=\"frm\">\n";
	print "<input type=\"hidden\" name=\"login\" value=".$context->getCourseName().'-'.$context->getUserShortName().'/'.$context->getUserShortName().">\n";
